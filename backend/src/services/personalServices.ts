import { Personal, PersonalNuevo } from '../types/typesPersonal';
import mysql from 'mysql2/promise';
import { personalSchema } from '../schema/personal.schema';

const conexion = mysql.createPool({
    //  Estos datos dependen de los parámetros que se hayan insertado
    //  en la imagen de docker de mysql, y los scripts que se hayan ejecutado.
    host: "localhost",
    user:"root",
    password: "prueba123",
